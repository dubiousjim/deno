...
unitTest(
  ...
  function futimeSyncFileSuccess(): void {
    const testDir = Deno.makeTempDirSync();
    const filename = testDir + "/file.txt";
    Deno.writeFileSync(filename, new TextEncoder().encode("hello"), {
      mode: 0o666,
...
unitTest(
  { ignore: Deno.build.os === "win", perms: { read: true, write: true } },
  function futimeSyncDateSuccess(): void {
    const testDir = Deno.makeTempDirSync();
    const filename = testDir + "/file.txt";
    Deno.writeFileSync(filename, new TextEncoder().encode("hello"), {
      mode: 0o666,
...
unitTest(
  ...
  function futimeSyncDenoPermFail(): void {
    let err;
    let caughtError = false;
    const atime = 1000;
    const mtime = 50000;
...
unitTest(
  { ignore: Deno.build.os === "win", perms: { read: true, write: false } },
  async function futimeDenoPermFail(): Promise<void> {
    let err;
    let caughtError = false;
    const atime = 1000;
    const mtime = 50000;
...
unitTest(
  { ignore: Deno.build.os === "win", perms: { read: true, write: true } },
  function futimeSyncModeFail(): void {
    let err;
    let caughtError = false;
    const atime = 1000;
    const mtime = 50000;
...
unitTest(
  { ignore: Deno.build.os === "win", perms: { read: true, write: true } },
  async function futimeModeFail(): Promise<void> {
    let err;
    let caughtError = false;
    const atime = 1000;
    const mtime = 50000;
